...
bool OpRunner::RunOp()
{
    ...
    auto ret = aclnnMatMulSubGetWorkspaceSize(inputTensor_[0],  inputTensor_[1], inputTensor_[2], 
    ...
    ret = aclnnMatMulSub(workspace, workspaceSize, handle, stream);
